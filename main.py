...
class MyContract(Contract):
    # property1 = fields.BooleanField()
    # property2 = fields.DateField()
    # property3 = fields.Integer()
    # property4 = fields.StringField()
    # property5 = fields.ListField(IntegerField())
    # property6 = fields.UUIDField()
...
class MySchema(Schema):
    ...
    # property5 = mmfields.List(fields.Integer())
...
data = dict(
    # property1=True,
    # property2=datetime.now().date().isoformat(),
    # property3=1234,
    # property4=generate_random_string(40),
    # property5=['1', '2', '3', '4'],
    # property6=str(uuid4()),
